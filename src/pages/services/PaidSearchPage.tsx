...
const PaidSearchPage = () => {
  return (
    <Layout>
      ...
      {/* 4b — CASE STUDY — YO! Sushi (parallax hero style) */}
      <section className="relative overflow-hidden min-h-[420px]">
        <div
          className="absolute inset-0 bg-cover bg-center bg-fixed"
          style={{ backgroundImage: `url(https://images.squarespace-cdn.com/content/v1/5edc691de451f275e3b4ae86/1726741909085-9P3RBLL2W17AYI8FMHV6/YO+Sushi.jpg)` }}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/50 to-black/20" />
        ...
        <div className="container-content mx-auto px-4 relative z-10 py-20">
          <ScrollReveal>
            ...
            <p className="text-white/80 text-base leading-relaxed max-w-2xl mb-4" style={{ textShadow: "0 1px 8px rgba(0,0,0,0.5)" }}>
              When YO! Sushi launched the Furi Furi Chicken — one of the most significant menu shake-ups in the brand's history — they needed more than great social content. They needed Google Ads that could reach high-intent audiences at scale and convert curiosity into visits.
            </p>
            <p className="text-white/70 text-base leading-relaxed max-w-2xl mb-8" style={{ textShadow: "0 1px 8px rgba(0,0,0,0.5)" }}>
          ...
          <ScrollReveal delay={100}>
            <div className="flex flex-wrap gap-4 mb-8">
              <AnimatedStatCard end={0} suffix="" label="Stat one · TBC" delay={0} />
              <AnimatedStatCard end={0} suffix="" label="Stat two · TBC" delay={150} />
              <AnimatedStatCard end={0} suffix="" label="Stat three · TBC" delay={300} />
            </div>
          </ScrollReveal>
      ...
      <TestimonialBlock
        ...
        role="Senior Growth & Digital Marketing Manager, YO! Sushi"
        ctaLabel="Book a Meeting"
        ctaHref="https://calendly.com/trapezemedia/discovery-call"
      />
