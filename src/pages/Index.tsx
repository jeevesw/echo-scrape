...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Short answer: only if you already know exactly what to do, and if you did, you probably wouldn't need either of us!\n\nAI is a powerful tool, but it amplifies expertise (rather than replacing it). In the right hands, it makes skilled people significantly more efficient, but without that foundation of knowledge and experience, you won't know what to ask it, how to direct it, or (it happens more often than we’d all like...) when it gets something wrong.\n\nWe're trained professionals who use AI to our advantage, which means we can work smarter and faster while still spotting the errors a non-expert would miss entirely (marketers have a sixth sense, you see).\n\nBut there's more to what we do than efficiency. We don't just follow templates or do what everyone else is doing. We never have. We take the time to genuinely understand your goals, and sometimes that means pushing back on your initial idea if there's a better route to where you want to get to. AI will generally give you what you ask for (it’s a people pleaser). We'll tell you if you're asking for the wrong thing (endearing honesty).",
  },
];
