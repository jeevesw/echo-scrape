          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mt-24">
            ...
            <ScrollReveal animation="left" className="order-2 lg:order-1">
              <div className="space-y-6">
                ...
                <p className="text-xl md:text-2xl text-foreground leading-relaxed">
                  We worked with Diversity member, street dancer and radio presenter Perri Kiely, who partnered with YO! to mark the Furi Furi launch at Bluewater — bringing his signature breakdancing moves to the conveyor belt and sharing the collab with his audience on social. The partnership landed coverage in the Mirror and helped cement Furi Furi Chicken as <span className="text-primary font-bold">one of YO!'s biggest menu shake-ups in the brand's history</span>.
                </p>
              </div>
            </ScrollReveal>
