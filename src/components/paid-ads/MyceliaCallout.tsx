  ...
  <section className="relative overflow-hidden min-h-[420px]">
    ...
    <div className="absolute inset-0 bg-zinc-800 flex items-center justify-center">
      <p className="text-white/30 text-xs text-center max-w-xs">
        Background image: Mycelia board game — atmospheric, close-up, dark tones. The game pieces and artwork fill the frame.
      </p>
    </div>
    ...
    <div className="relative z-10 flex flex-col justify-end px-8 md:px-16 pb-12 pt-32 max-w-5xl mx-auto">
      <p className="text-primary text-xs tracking-widest font-semibold uppercase mb-3">
